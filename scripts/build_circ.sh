...
BIN=./modules/circ/target/release/examples/circ
export CARGO_MANIFEST_DIR=$(pwd)

case "$OSTYPE" in 
    darwin*)
        alias measure_time="gtime --format='LOG: $1 Time / Memory: %e seconds %M kB'"
    ;;
    linux*)
        alias measure_time="time --format='LOG: $1 Time / Memory: %e seconds %M kB'"
    ;;
esac
...
mpc_test 2 ./examples/C/mpc/benchmarks/cryptonets/cryptonets.c $1 $2

# build OPA benchmarks
mpc_test 2 ./examples/C/mpc/benchmarks/histogram/histogram.c $1 $2
